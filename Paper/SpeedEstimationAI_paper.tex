...
El modelo multimodal obtuvo el mejor desempeño con un MAE de prueba de 4.45 km/h y MAE de validación de 4.46 km/h, superando al modelo basado en imágenes (12.53 km/h) y al mejor modelo tabular (7.3 km/h). La integración multimodal redujo el error en 64.5\% respecto al modelo visual y en 39.0\% respecto al modelo tabular, evidenciando que ambas modalidades aportan información
complementaria para la estimación.
