...
JS;
    ...
    private function extraerDatosIncidente(Incidente $incidente, Reporte $reporte): array
    {
        ...
        return [
            ...
            'numero_mediciones_def'  => $deformacion?->numero_mediciones,
            'c1_m'                   => $deformacion?->c1_m,
            'c2_m'                   => $deformacion?->c2_m,
            'c3_m'                   => $deformacion?->c3_m,
            'c4_m'                   => $deformacion?->c4_m,
            'c5_m'                   => $deformacion?->c5_m,
            'c6_m'                   => $deformacion?->c6_m,
            'l_ancho_m'              => $deformacion?->l_ancho_contacto_m,
            'angulo_fpi'             => $deformacion?->angulo_fpi_grados,

            // Cálculo de velocidad — resultados almacenados
            'a_rigidez'              => $calculo?->a_rigidez_n_m,
            'b_rigidez'              => $calculo?->b_rigidez_n_m2,
            'dmed_m_cal'             => $calculo?->dmed_m,
            'e_deformacion'          => $calculo?->e_deformacion_julios,
            'e_corregida'            => $calculo?->e_def_corregida_julios,
            'ebs_ms'                 => $calculo?->ebs_m_s,
            'dv_kmh'                 => $calculo?->velocidad_impacto_kmh,
            'velocidad_pre_impacto'  => $calculo?->velocidad_pre_impacto_kmh,
            'velocidad_limpert'      => $calculo?->velocidad_limpert_kmh,
