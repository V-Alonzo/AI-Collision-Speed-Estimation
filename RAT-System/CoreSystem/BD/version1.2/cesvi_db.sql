...
--   • Se crean RAT_CAT_TIPO_HECHO y RAT_CAT_TIPO_VIA como catálogos propios
--     del módulo RAT (no existen en la plataforma base).
...
CREATE TABLE RAT_INCIDENTE (
  ...
  tipo_hecho_id      INT          NOT NULL COMMENT 'FK → RAT_CAT_TIPO_HECHO.id',
...
<<<<<<< HEAD
  ...
  tipo_via_id                    INT           NULL     COMMENT 'FK → RAT_CAT_TIPO_VIA.id',
=======
  velocidad_maxima_permitida_kmh INT           NULL,
...
INSERT INTO RAT_PLANTILLA_VARIABLE (clave, descripcion, tabla_origen, columna_origen, formato) VALUES
  ...
  ('{{tipo_hecho}}',           'Tipo de hecho de tránsito',               'RAT_CAT_TIPO_HECHO',      'nombre',                          'texto'),
  ...
  ('{{tipo_via}}',             'Tipo de vía',                             'RAT_CAT_TIPO_VIA',        'nombre',                          'texto'),
...
--
-- Tablas nuevas vs v1.1:
--   ✚ RAT_CAT_TIPO_HECHO → catálogo propio (no existe en plataforma base)
--   ✚ RAT_CAT_TIPO_VIA   → catálogo propio (no existe en plataforma base)
--
-- Tablas nuevas vs v3:
...
--   Catálogos propios: 27  (RAT_CAT_*)
--   Tablas técnicas  :  3  (RAT_TABLA_*)
--   Transaccionales  : 16  (RAT_INCIDENTE → RAT_CONCLUSION)
--   Plantilla        :  4  (RAT_PLANTILLA*)
-- Tablas referenciadas de plataforma base: sys_users
=======
-- FIN DEL SCRIPT
-- Tablas creadas: 40
--   Catálogos    : 27  (CAT_*)
