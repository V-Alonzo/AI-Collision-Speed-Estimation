# Image Velocity Estimator trained with augmented data (15513 samples) 60 Epochs, Custom FC, Unfreeze resnet.layer4 and modified loss funtion from smooth_l1_loss to l1_loss

The main purpose of this experiment is training with the resnet50 backbone with the following arq configuration and custom fully connected arquitecture and l1_loss
