...
from model.config.ImageVelocityEstimator.config import IO_DATASET_MAP_LOCAL_PATH, DEVICE
from model.config.ImageVelocityEstimator.config import CHECKPOINTS_DIR_PATH, TRAININGLOGS_DIR_PATH, MODEL_NAME, MODEL_SERIALIZED_PATH
from model.config.ImageVelocityEstimator.config import IMAGE_CHANNELS
from model.config.ImageVelocityEstimator.config import EARLY_STOPPING_PATIENCE, TRAINER_ACCELERATOR, TRAINER_PRECISION, METRICS_PLOTS_OUTPUT_DIR_PATH
